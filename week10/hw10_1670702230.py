...
def layout(master):
    ...
    tkinter.Label(login, text='Username:', bg='#F5EFE7', font=('Arial', 16), fg="black").grid(row=0, column=1, sticky='w')
    usename = tkinter.Entry(login, width=25, font=('Arial', 16), bg='white')
    ...
    pwd = tkinter.Entry(login, width=25, font=('Arial', 16), show='*', bg='white')
